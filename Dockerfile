...
# Versiones fijadas por uv.lock (Python 3.12, Linux)
COPY <<EOF /tmp/requirements.lock
scikit-learn==1.9.0
mlflow==3.4.0
xgboost==3.2.0
matplotlib==3.10.9
...
# DAG embebido para evitar problemas de bind mount en Windows/WSL2
# El fuente canónico está en dags/fraud_detection.py
COPY <<'DAGEOF' /opt/airflow/dags/fraud_detection.py
